...
class CarbonProcessingUnitData(UnitModelBlockData):
    ...
    def calculate_scaling_factors(self):
        ...
        iscale.set_scaling_factor(self.inlet_flow_mol[0.0], 1)
        iscale.set_scaling_factor(self.pureco2_flow_mol[0.0], 1)
        iscale.set_scaling_factor(self.water_flow_mol[0.0], 1)
        iscale.set_scaling_factor(self.vent_flow_mol[0.0], 1)
